/**
 * CompactReadingStats - Mobile-optimized 3x2 grid layout for reading statistics
 */
...
interface CompactReadingStatsProps {
  stats: ReadingStats;
}
...
export default function CompactReadingStats({ stats }: CompactReadingStatsProps) {
