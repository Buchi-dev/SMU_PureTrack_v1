 ...
 *
 * @param {CallableRequest<TRequest>} request - Firebase Callable request object
 * @param {ActionHandlers<TRequest, TResponse>} handlers - Map of action names to handler functions
 * @param {string} actionField - Name of the field in request.data that contains the action (default: 'action')
 *
 * @return {Promise<TResponse>} Promise resolving to the handler's response
 *
